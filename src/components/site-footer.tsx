      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 md:grid-cols-[1.3fr_1fr_1fr_1fr]">
        <div className="space-y-4">
          ...
          <p className="max-w-sm text-sm text-muted-foreground">
            A community-powered Solana project focused on clear token information, official mint
            verification, transparent resources, and responsible participation.
          </p>
          <ContractBar />
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
            ...
            <Link to="/chart" className="hover:text-foreground">
              Live chart
            </Link>
